...
@Component({
  selector: 'app-cleaning-add-master',
  templateUrl: './cleaning-add-master.component.html',
  styleUrls: ['./cleaning-add-master.component.scss']
})
export class CleaningAddMasterComponent {
  ...
  onBack() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/add-cleaning']); // ใช้ Router เพื่อนำทาง
      }
    });
  }
}
