...
@Component({
  selector: 'app-summary-cleaning',
  templateUrl: './summary-cleaning.component.html',
  styleUrls: ['./summary-cleaning.component.scss']
})
export class SummaryCleaningComponent {
  // ตัวแปรข้อมูล
  docNo = 'TN2411130001';
  division = 'GM';
  factory = '2';
