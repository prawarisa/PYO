...
@Component({
  selector: 'app-cleaning-add-excel',
  templateUrl: './cleaning-add-excel.component.html',
  styleUrls: ['./cleaning-add-excel.component.scss']
})
export class CleaningAddExcelComponent {
...
onUpload() {
  ...
  onBack() {
    ...
    this.router.navigate(['/pages/add-cleaning']); // นำทางไปยังหน้า /pages/cutting
  }
}
