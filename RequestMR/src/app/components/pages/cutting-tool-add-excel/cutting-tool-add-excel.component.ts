...
@Component({
  selector: 'app-cutting-tool-add-excel',
  templateUrl: './cutting-tool-add-excel.component.html',
  styleUrls: ['./cutting-tool-add-excel.component.scss']
})
export class CuttingToolAddExcelComponent {
...
onUpload() {
  ...
  onBack() {
    ...
    this.router.navigate(['/pages/add-cuttingtool']); // นำทางไปยังหน้า /pages/cutting
  }
}
