...
@Component({
  selector: 'app-grinding-add-excel',
  templateUrl: './grinding-add-excel.component.html',
  styleUrls: ['./grinding-add-excel.component.scss']
})
export class GrindingAddExcelComponent {
...
onUpload() {
  ...
  onBack() {
    ...
    this.router.navigate(['/pages/add-grinding']); // นำทางไปยังหน้า /pages/cutting
  }
}
