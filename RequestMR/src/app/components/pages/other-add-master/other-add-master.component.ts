...
@Component({
  selector: 'app-other-add-master',
  templateUrl: './other-add-master.component.html',
  styleUrls: ['./other-add-master.component.scss']
})
export class OtherAddMasterComponent {
  ...
  onBack() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/add-other']); // ใช้ Router เพื่อนำทาง
      }
    });
  }
}
