...
@Component({
  selector: 'app-list-request-other',
  templateUrl: './list-request-other.component.html',
  styleUrls: ['./list-request-other.component.scss']
})
export class ListRequestOtherComponent {
  items = [
  ...
  viewDetail(docNo: string): void {
    this.router.navigate(['/pages/detail-request-other', docNo]);
  }
