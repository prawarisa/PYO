...
@Component({
  selector: 'app-list-return-grinding',
  templateUrl: './list-return-grinding.component.html',
  styleUrls: ['./list-return-grinding.component.scss']
})
export class ListReturnGrindingComponent {
  ...
  onDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-return-grinding']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
  ...
  onReturn(docNo: string): void {
    ...
    this.router.navigate(['/pages/return-grinding-user']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
}
