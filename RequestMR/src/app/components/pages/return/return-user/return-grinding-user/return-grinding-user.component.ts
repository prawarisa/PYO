...
@Component({
  selector: 'app-return-grinding-user',
  templateUrl: './return-grinding-user.component.html',
  styleUrls: ['./return-grinding-user.component.scss']
})
export class ReturnGrindingUserComponent implements OnInit {
  ...
  onReturn(docNo: string): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/list-return-grindind']); // Example: Navigate to another page
