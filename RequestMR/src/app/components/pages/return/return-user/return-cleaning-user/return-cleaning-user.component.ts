...
@Component({
  selector: 'app-return-cleaning-user',
  templateUrl: './return-cleaning-user.component.html',
  styleUrls: ['./return-cleaning-user.component.scss']
})
export class ReturnCleaningUserComponent implements OnInit {
  ...
  onReturn(docNo: string): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/list-return-cleaning']); // Example: Navigate to another page
