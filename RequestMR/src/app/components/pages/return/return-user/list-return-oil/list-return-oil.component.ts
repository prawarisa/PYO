...
@Component({
  selector: 'app-list-return-oil',
  templateUrl: './list-return-oil.component.html',
  styleUrls: ['./list-return-oil.component.scss']
})
export class ListReturnOilComponent {
  ...
  onDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-return-oil']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
  ...
  onReturn(docNo: string): void {
    ...
    this.router.navigate(['/pages/return-oil-user']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
}
