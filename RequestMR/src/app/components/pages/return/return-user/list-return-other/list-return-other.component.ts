...
@Component({
  selector: 'app-list-return-other',
  templateUrl: './list-return-other.component.html',
  styleUrls: ['./list-return-other.component.scss']
})
export class ListReturnOtherComponent {
  ...
  onDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-return-other']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
  ...
  onReturn(docNo: string): void {
    ...
    this.router.navigate(['/pages/return-other-user']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
}
