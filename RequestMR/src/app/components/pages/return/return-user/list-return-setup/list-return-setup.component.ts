...
@Component({
  selector: 'app-list-return-setup',
  templateUrl: './list-return-setup.component.html',
  styleUrls: ['./list-return-setup.component.scss']
})
export class ListReturnSetupComponent {
  ...
  onDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-return-setup']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
  ...
  onReturn(docNo: string): void {
    ...
    this.router.navigate(['/pages/return-setup-user']); // เปลี่ยนหน้าเป็นหน้า /pages/return-cleaning
  }
}
