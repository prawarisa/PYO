...
@Component({
  selector: 'app-return-oil-user',
  templateUrl: './return-oil-user.component.html',
  styleUrls: ['./return-oil-user.component.scss']
})
export class ReturnOilUserComponent implements OnInit {
  ...
  onReturn(docNo: string): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/list-return-oil']); // Example: Navigate to another page
