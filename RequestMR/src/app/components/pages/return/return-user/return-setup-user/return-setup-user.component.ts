...
@Component({
  selector: 'app-return-setup-user',
  templateUrl: './return-setup-user.component.html',
  styleUrls: ['./return-setup-user.component.scss']
})
export class ReturnSetupUserComponent implements OnInit {
  ...
  onReturn(docNo: string): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/list-return-setup']); // Example: Navigate to another page
