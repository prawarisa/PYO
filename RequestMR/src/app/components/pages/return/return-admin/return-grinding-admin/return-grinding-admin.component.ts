...
@Component({
  selector: 'app-return-grinding-admin',
  templateUrl: './return-grinding-admin.component.html',
  styleUrls: ['./return-grinding-admin.component.scss']
})
export class ReturnGrindingAdminComponent {
  ...
  goToDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-grinding']);
  }
