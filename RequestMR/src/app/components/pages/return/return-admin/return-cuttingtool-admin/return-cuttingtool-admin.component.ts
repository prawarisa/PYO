...
@Component({
  selector: 'app-return-cuttingtool-admin',
  templateUrl: './return-cuttingtool-admin.component.html',
  styleUrls: ['./return-cuttingtool-admin.component.scss']
})
export class ReturnCuttingtoolAdminComponent {
  ...
  goToDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-cuttingtool']);
  }
