...
@Component({
  selector: 'app-return-cleaning-admin',
  templateUrl: './return-cleaning-admin.component.html',
  styleUrls: ['./return-cleaning-admin.component.scss']
})
export class ReturnCleaningAdminComponent {
  ...
  goToDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-cleaning']);
  }
