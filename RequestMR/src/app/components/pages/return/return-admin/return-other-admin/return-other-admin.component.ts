...
@Component({
  selector: 'app-return-other-admin',
  templateUrl: './return-other-admin.component.html',
  styleUrls: ['./return-other-admin.component.scss']
})
export class ReturnOtherAdminComponent {
  ...
  goToDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-other']);
  }
