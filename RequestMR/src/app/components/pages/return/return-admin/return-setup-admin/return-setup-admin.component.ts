...
@Component({
  selector: 'app-return-setup-admin',
  templateUrl: './return-setup-admin.component.html',
  styleUrls: ['./return-setup-admin.component.scss']
})
export class ReturnSetupAdminComponent {
  ...
  goToDetail(docNo: string): void {
    ...
    this.router.navigate(['/pages/detail-setup']);
  }
