...
@Component({
  selector: 'app-other-add-excel',
  templateUrl: './other-add-excel.component.html',
  styleUrls: ['./other-add-excel.component.scss']
})
export class OtherAddExcelComponent {
...
onUpload() {
  ...
  onBack() {
    ...
    this.router.navigate(['/pages/add-other']); // นำทางไปยังหน้า /pages/cutting
  }
}
