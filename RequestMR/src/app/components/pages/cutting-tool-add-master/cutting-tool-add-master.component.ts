...
@Component({
  selector: 'app-cutting-tool-add-master',
  templateUrl: './cutting-tool-add-master.component.html',
  styleUrls: ['./cutting-tool-add-master.component.scss']
})
export class CuttingToolAddMasterComponent {
