...
@Component({
  selector: 'app-request-grinding',
  templateUrl: './request-grinding.component.html',
  styleUrls: ['./request-grinding.component.scss']
})
export class RequestGrindingComponent {
  // ตัวเลือกใน Dropdown
  Div = [
    { label: 'GM', value: 'GM' },
    { label: 'PMC', value: 'PMC' }
