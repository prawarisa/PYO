...
@Component({
  selector: 'app-summary-grinding',
  templateUrl: './summary-grinding.component.html',
  styleUrls: ['./summary-grinding.component.scss']
})
export class SummaryGrindingComponent {
  // ตัวแปรข้อมูล
  docNo = 'TN2411130001';
  division = 'GM';
  factory = '2';
