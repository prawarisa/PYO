...
@Component({
  selector: 'app-grinding-add-master',
  templateUrl: './grinding-add-master.component.html',
  styleUrls: ['./grinding-add-master.component.scss']
})
export class GrindingAddMasterComponent {
  ...
  onBack() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['/pages/add-grinding']); // ใช้ Router เพื่อนำทาง
      }
    });
  }
}
