...
@Component({
  selector: 'app-receive-cleaning',
  templateUrl: './receive-cleaning.component.html',
  styleUrls: ['./receive-cleaning.component.scss']
})
export class ReceiveCleaningComponent {
  // ข้อมูลตาราง
  tableData = [
    {
      docNo: 'TN2411130003',
