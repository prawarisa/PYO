...
@Component({
  selector: 'app-list-request-grinding',
  templateUrl: './list-request-grinding.component.html',
  styleUrls: ['./list-request-grinding.component.scss']
})
export class ListRequestGrindingComponent {
  items = [
  ...
  viewDetail(docNo: string): void {
    this.router.navigate(['/pages/detail-request-grinding', docNo]);
  }
