...
@Component({
  selector: 'app-set-up-add-excel',
  templateUrl: './set-up-add-excel.component.html',
  styleUrls: ['./set-up-add-excel.component.scss']
})
export class SetUpAddExcelComponent {
...
onUpload() {
  ...
  onBack() {
    ...
    this.router.navigate(['/pages/add-set-up']); // นำทางไปยังหน้า /pages/cutting
  }
}
